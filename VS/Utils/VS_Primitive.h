...
vsFragment *	vsMakeFringedBox2D( const vsBox2D &box, const vsString &material, const vsColor *colorOverride = NULL );

vsFragment *	vsMakeSolidBox2D( const vsBox2D &box, const vsString &material, const vsColor *colorOverride = NULL );
vsFragment *	vsMakeTexturedBox2D( const vsBox2D &box, const vsString &material, const vsColor *colorOverride = NULL );
vsFragment *	vsMakeTexturedBox2D( const vsBox2D &box, const vsString &material, const vsVector2D& texScale, const vsVector2D& texOffset = vsVector2D::Zero, const vsColor *colorOverride = NULL );
...
vsFragment *	vsMakeTexturedBox2D_FlipV( const vsBox2D &box, const vsString &material, const vsColor *colorOverride = NULL );
vsFragment *	vsMakeTiledTexturedBox2D( const vsBox2D &box, const vsString &material, float tileSize, const vsAngle &angle = vsAngle::Zero, const vsColor *colorOverride = NULL );
vsFragment *	vsMakeOutlineBox2D( const vsBox2D &box, const vsString &material, const vsColor *colorOverride = NULL );


vsFragment *	vsMakeSolidBox2D_AtOffset( const vsBox2D &box, const vsVector3D &offset, const vsString &material, const vsColor *colorOverride = NULL );

vsFragment *	vsMakeSolidBox3D( const vsBox3D &box, vsMaterial *material, const vsColor *colorOverride = NULL );
vsFragment *	vsMakeTexturedBox3D( const vsBox3D &box, vsMaterial *material, const vsColor *colorOverride = NULL );
vsFragment *	vsMakeOutlineBox3D( const vsBox3D &box, vsMaterial *material, const vsColor *colorOverride = NULL );

vsFragment *	vsMakeSolidBox3D( const vsBox3D &box, const vsString &material, const vsColor *colorOverride = NULL );
vsFragment *	vsMakeTexturedBox3D( const vsBox3D &box, const vsString &material, const vsColor *colorOverride = NULL );
vsFragment *	vsMakeOutlineBox3D( const vsBox3D &box, const vsString &material, const vsColor *colorOverride = NULL );
