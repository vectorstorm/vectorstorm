...
void
vsRenderBuffer::SetArray_Internal( void *data, int size, BindType bindType )
{
	...
	switch( bindType )
	{
		case BindType_Attribute:
			bindPoint = GL_ARRAY_BUFFER;
			break;
		case BindType_Element:
			bindPoint = GL_ELEMENT_ARRAY_BUFFER;
			break;
		case BindType_UniformBuffer:
			bindPoint = GL_UNIFORM_BUFFER;
			break;
		default:
			vsAssert(0, "Unhandled bind type??");
	}
...
void
vsRenderBuffer::SetUniformBuffer( void* data, int dataLength )
{
	m_contentType = ContentType_UniformBuffer;
	SetArray_Internal( data, dataLength, BindType_UniformBuffer );
}

void
vsRenderBuffer::BindUniformBuffer( int bindPoint )
{
	glBindBufferRange(GL_UNIFORM_BUFFER, bindPoint, m_bufferID, 0, m_activeBytes);
}

void
vsRenderBuffer::UnbindUniformBuffer( int bindPoint )
{
...
vsRenderBuffer::SetArray( const vsRenderBuffer::P *array, int size )
{
	...
	SetArray_Internal((char *)array, size*sizeof(vsRenderBuffer::P), BindType_Attribute);
}
...
vsRenderBuffer::SetArray( const vsRenderBuffer::PC *array, int size )
{
	...
	SetArray_Internal((char *)array, size*sizeof(vsRenderBuffer::PC), BindType_Attribute);
}
...
vsRenderBuffer::SetArray( const vsRenderBuffer::PT *array, int size )
{
	...
	SetArray_Internal((char *)array, size*sizeof(vsRenderBuffer::PT), BindType_Attribute);
}
...
vsRenderBuffer::SetArray( const vsRenderBuffer::PN *array, int size )
{
	...
	SetArray_Internal((char *)array, size*sizeof(vsRenderBuffer::PN), BindType_Attribute);
}
...
vsRenderBuffer::SetArray( const vsRenderBuffer::PCT *array, int size )
{
	...
	SetArray_Internal((char *)array, size*sizeof(vsRenderBuffer::PCT), BindType_Attribute);
}
...
vsRenderBuffer::SetArray( const vsRenderBuffer::PNT *array, int size )
{
	...
	SetArray_Internal((char *)array, size*sizeof(vsRenderBuffer::PNT), BindType_Attribute);
}
...
vsRenderBuffer::SetArray( const vsRenderBuffer::PCN *array, int size )
{
	...
	SetArray_Internal((char *)array, size*sizeof(vsRenderBuffer::PCN), BindType_Attribute);
}
...
vsRenderBuffer::SetArray( const vsRenderBuffer::PCNT *array, int size )
{
	...
	SetArray_Internal((char *)array, size*sizeof(vsRenderBuffer::PCNT), BindType_Attribute);
}
...
vsRenderBuffer::SetArray( const vsMatrix4x4 *array, int size )
{
	...
	SetArray_Internal((char *)array, size*sizeof(vsMatrix4x4), BindType_Attribute);
}
...
{
	m_contentType = ContentType_P;
	SetArray_Internal((char *)array, size*sizeof(vsVector3D), BindType_Attribute);
}

void
vsRenderBuffer::SetArray( const vsVector2D *array, int size )
{
	SetArray_Internal((char *)array, size*sizeof(vsVector2D), BindType_Attribute);
}

void
vsRenderBuffer::SetArray( const vsColor *array, int size )
{
	SetArray_Internal((char *)array, size*sizeof(vsColor), BindType_Attribute);
}

void
vsRenderBuffer::SetArray( const uint16_t *array, int size )
{
	SetArray_Internal((char *)array, size*sizeof(uint16_t), BindType_Element);
}
...
{
	SetArray_Internal( m_array, m_activeBytes, BindType_Attribute );
}

void
vsRenderBuffer::BakeIndexArray()
{
	SetArray_Internal( m_array, m_activeBytes, BindType_Element );
}
...
vsRenderBuffer::MapAll()
{
	...
	for ( vsRenderBuffer *b = vsRenderBuffer::GetFirstInstance(); b; b = b->GetNextInstance() )
	{
		...
		if ( b->m_bindType == BindType_Element )
		{
